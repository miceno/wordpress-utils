 ...
 *
 * Configure GA_USERID constant with the value for the Google Analytics tracking code.
 *
 * For example:
 *
 *  define('GA_USERID', 'XX-ZZZZZZ')
 *
*/
...
function custom_google_analytics() {
	if ( defined( "GA_USERID" ) ) { ?>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=<?php echo GA_USERID; ?>"></script>
        <script>
            ...
            gtag('js', new Date());
            gtag('config', '<?php echo GA_USERID; ?>');
        </script><?php
	}
}
